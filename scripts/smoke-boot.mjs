...
//
// dsh-approval-policy note: with no UI surfaces registered the waterfall answerer
...
const ownName = pkg.name // @aiwayds/dsh-approval-policy

const work = mkdtempSync(path.join(tmpdir(), 'dsh-approval-policy-smoke-'))
...
if (dumpAfter.stdout.includes('dsh-approval-policy')) {
